...
if((date("Y-m-d")-$bd)>=18)$bdcheck=true;
if(strlen($username)>=5) $usernamecheck=true;
if($pass1==$pass2) $passcheck=true;
echo "<h2 style='color:red;'>";
if(!$bdcheck) echo "under 18!";
else if(!$usernamecheck) echo "username must be 5 letters or more!";
else if(!$passcheck) echo "password and confirmation missmatch!";
